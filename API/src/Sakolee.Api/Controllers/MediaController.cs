using Sakolee.Api.Models.Media;
using Sakolee.Api.Security;
using Sakolee.Api.Storage;
using Sakolee.Application.Abstractions.Persistence;
using Sakolee.Application.Abstractions.Storage;
using Sakolee.Shared.Contracts;
using Sakolee.Shared.Security;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using DomainMedia = Sakolee.Domain.Entities.Media;
using EntityTypeEnum = Sakolee.Domain.Enums.EntityType;
using MediaTypeEnum = Sakolee.Domain.Enums.MediaType;
using MediaCategoryEnum = Sakolee.Domain.Enums.MediaCategory;
