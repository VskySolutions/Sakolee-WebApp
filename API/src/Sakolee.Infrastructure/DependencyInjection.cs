...
using Sakolee.Infrastructure.Auditing;
using Sakolee.Infrastructure.Tenancy;
using Sakolee.Infrastructure.Persistence;
using Sakolee.Infrastructure.Persistence.Repositories;
...
namespace Sakolee.Infrastructure;
...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddDbContext<SakoleeDbContext>((sp, options) =>
        ...
        services.AddDataProtection()
            .PersistKeysToDbContext<SakoleeDbContext>()
            .SetApplicationName("Sakolee");
    ...
    /// <see cref="SakoleeDbContext"/> so writes commit in a single transaction.
    /// </summary>
