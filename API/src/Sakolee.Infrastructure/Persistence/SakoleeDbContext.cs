...
/// <summary>
/// EF Core unit of work for the Sakolee application schema. Owns the
...
/// </para>
/// </summary>
public class SakoleeDbContext : DbContext, IDataProtectionKeyContext
{
    private readonly ITenantContext _tenantContext;
    private readonly IActorAccessor _actorAccessor;

    public SakoleeDbContext(
        DbContextOptions<SakoleeDbContext> options,
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(SakoleeDbContext).Assembly);
