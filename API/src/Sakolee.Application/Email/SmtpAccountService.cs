...
namespace Sakolee.Application.Email;
...
public sealed class SmtpAccountService : ISmtpAccountService
{
    ...
    public async Task<SmtpTestResult?> TestSendAsync(Guid id, Guid tenantId, string recipientEmail, CancellationToken cancellationToken = default)
    {
        ...
        var message = new SmtpMessage(
            recipientEmail.Trim(),
            Subject: "Sakolee SMTP test message",
            Body: $"This is a test message sent from the Sakolee SMTP account '{account.AccountName}' ({account.Host}:{account.Port}). " +
