export default [
  {
    ...
    children: [
      // Route for listing all sessions (Index Page)
      {
        ...
        meta: { requiresAuth: true, permissions: ["sessions.read"], title: "Sessions" }
      },
      // Route for creating a new session record
      {
        ...
        meta: { requiresAuth: true, permissions: ["sessions.write"], title: "Create Session" }
      },
    ...
    //     name: "session_edit",
    //     component: () => import("modules/session/components/create_edit_session.vue"),
    //     meta: { requiresAuth: true, permissions: ["sessions.write"], title: "Edit Session" }
    //   },
      // Route for viewing detailed information of a specific session record
      {
        ...
        meta: { requiresAuth: true, permissions: ["sessions.read"], title: "Session Details" }
      }
    ]
  }
];