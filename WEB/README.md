...
The admin SPA for the Sakolee multi-tenant platform, built with **Quasar 2 / Vue 3**. It
provides the UI for tenants, people, users, roles and permission groups, option sets, email accounts and
templates, and the Universal Features layer, against the Sakolee REST API.
